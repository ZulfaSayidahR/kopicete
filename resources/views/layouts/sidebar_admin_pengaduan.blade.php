    ...
    <nav class="sa-navigation">
        ...
        <ul class="sa-menu">
            ...
            <li class="sa-menu-item
                {{ request()->routeIs('adminpengaduan.dashboard') ? 'active' : '' }}">

                <a href="{{ route('adminpengaduan.dashboard') }}">
            ...
            {{-- Pengaduan --}}
            <li class="sa-menu-item {{ request()->routeIs('adminpengaduan.data_pengaduan') ? 'active' : '' }}">
